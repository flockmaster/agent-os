...
本文件定义 Agent OS 的模型后端配置。通过切换 `ACTIVE_PROVIDER`，
...
```yaml
ACTIVE_PROVIDER: claude   # 改为 claude / copilot
```
...
| 功能 | Gemini | Claude | Copilot |
|------|--------|--------|---------|
| 工作流执行 | ✅ | ✅ | ✅ |
| PRD 生成 | ✅ | ✅ | ✅ |
| 知识收割 | ✅ | ✅ | ✅ |
| Git 守卫 | ✅ | ✅ | ✅ |
| Dispatcher (自动调度) | ✅ | ⚠️ 需 exec 模式 | ⚠️ 需 exec 模式 |
| JSONL 事件流 | ✅ | ❌ 不支持 | ❌ 不支持 |
| Session 看门狗 | ✅ | ✅ | ✅ |
| 反思引擎 | ✅ | ✅ | ✅ |
